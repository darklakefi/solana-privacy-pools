/// Compatibility layer for tests that use the old Borsh-based types
use pinocchio::{
...
// Implement minimal BorshSerialize/Deserialize for tests
...
/// Account validation helpers for tests
